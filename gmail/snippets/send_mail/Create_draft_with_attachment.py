...
def gmailCreateDraftWithAttachment():
    """Create and insert a draft email with attachment. Print the returned draft's message and id.
    ...
    try:
        ...
        file_name = 'photo.jpg'
        message = {'message': create_message(sender=sender, to=to, subject=subject, message_text=message_body,
                                             file=file_name)}
